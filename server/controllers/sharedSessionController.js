...
// Asegurar que los modelos están cargados correctamente
let ParticipantAllocation;
let PersonalExpense;

try {
  ParticipantAllocation = require('../models/ParticipantAllocation');
} catch (error) {
  console.error('Error al cargar el modelo ParticipantAllocation:', error);
  try {
    ParticipantAllocation = mongoose.model('ParticipantAllocation');
  } catch (modelError) {
    console.error('No se pudo obtener el modelo ParticipantAllocation:', modelError);
  }
}
...
try {
  ...
  console.error('Error al cargar el modelo PersonalExpense:', error);
  try {
    PersonalExpense = mongoose.model('PersonalExpense');
  } catch (modelError) {
    console.error('No se pudo obtener el modelo PersonalExpense:', modelError);
  }
}
    ...
    try {
        ...
        try {
            ...
            try {
                ...
                console.error('Error al cargar modelos necesarios:', modelError);
                // No interrumpir el proceso por este error
                await dbSession.commitTransaction();
