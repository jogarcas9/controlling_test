...
// NO sobreescribir MONGODB_URI si ya está definida
if (!process.env.MONGODB_URI && !process.env.MONGODB_URI_PRODUCTION && !process.env.MONGODB_URI_QUALITY) {
  process.env.MONGODB_URI = 'mongodb+srv://jogarcas29:7JAw4tGRRjos9I8d@homeexpenses.acabyfv.mongodb.net/controlling_app';
}
